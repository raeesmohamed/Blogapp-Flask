...
from flaskblog.user.form import RegistrationForm, LoginForm, UpdateForm, ResetPasswordForm, RequestResetForm
from flaskblog.user.utils import save_pic, send_reset_email 
...
def account():
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash("Username and email is updated", "success")
